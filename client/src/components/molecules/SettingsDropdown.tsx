...
const SettingsDropdown: FC<dropdownProps> = ({ name, clientX, clientY, type }) => {
    ...
    return (
        <Container visibility={yPosition ? true : false} ref={dropdownRef} x={clientX} y={yPosition}>
            <List>
                <ListItem>
                    <ItemButton>change name</ItemButton>
                </ListItem>
